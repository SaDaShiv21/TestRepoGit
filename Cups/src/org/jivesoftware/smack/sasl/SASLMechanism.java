...
public abstract class SASLMechanism implements CallbackHandler {
    ...
    public void authenticate(String username, String host, String password) throws IOException, XMPPException {
        ...
        this.hostname = host;
        System.out.println("Authenticating>>> "+"username:"+username+" pwd:"+password+" Host"+host);

        String[] mechanisms = { getName() };
        Map<String,String> props = new HashMap<String,String>(); //System.out.println(props);
    ...
    protected void authenticate() throws IOException, XMPPException {
        ...
        try {
            if(sc.hasInitialResponse()) {
                ...
                //System.out.println("Authenticated with auth text:"+authenticationText);
            }
