...
public class BOSHConnection extends Connection {
    ...
    public void connect() throws XMPPException {
        ...
        try {
            ...
            //casted >> client.addBOSHClientConnListener(new BOSHConnectionListener(this));
            client.addBOSHClientConnListener(new BOSHConnectionListener(this));
            //client.addBOSHClientConnListener((BOSHClientConnListener) new BOSHConnectionListener(this));
            //client.addBOSHClientResponseListener(new BOSHPacketReader(this));// >> casted this statement
            client.addBOSHClientResponseListener((BOSHClientResponseListener) new BOSHPacketReader(this));
